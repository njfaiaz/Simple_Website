                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                ...
                                <li class="remove">
                                    <a href="{{ route('slider.add') }}" class="btn btn-primary btn-block waves-effect waves-light">Add Slider</a>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($slider as $key=> $member)
                                        <tr>
                                            <td>{{$member->id}}</td>
                                            <td>
                                                <div style="height: 50px; width:100px;">
                                                    <img alt="" src="{{ asset($member->slider) }}">
                                                </div>
                                            </td>
                                            <td>
                                                <a href="{{route('slider.edit',['id'=>$member->id])}}" class="btn btn-info">Edit</a>
                                                <a href="{{route('slider.delete',['id'=>$member->id])}}" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
