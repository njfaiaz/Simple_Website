                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($marque as $key=> $member)
                                        <tr>
                                            <td>{{$member->id}}</td>
                                            <td>{{$member->marque}}</td>

                                            <td>
                                                <a href="{{route('marque.edit',['id'=>$member->id])}}" class="btn btn-info">Edit</a>
                                                <a href="{{route('marque.delete',['id'=>$member->id])}}" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
