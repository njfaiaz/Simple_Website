                            ...
                            <form action="{{route('board.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control" id="image"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group form-float">
                                            <textarea name="disc" cols="30" rows="5" placeholder="Description" class="form-control no-resize" required></textarea>
                                        </div>
                                    </div>
