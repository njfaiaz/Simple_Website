            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="{{route('project.update',$slider->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{ $slider->id }}">
                                <input type="hidden" name="old_image" value="{{ $slider->id }}">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12 mt-3">
                                        <div class="form-group form-float">
                                            <textarea name="project_dec" cols="30" rows="5" placeholder="Description" class="form-control no-resize" required> {{ $slider->project_dec }} </textarea>
                                        </div>
                                    </div>
                                </div>
