                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                ...
                                <li class="remove">
                                    <a href="{{ route('project.add') }}" class="btn btn-primary btn-block waves-effect waves-light">Add Slider</a>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{Str::limit($member->project_dec, 25) }}</td>

                                            <td>
                                                <a href="{{route('project.edit',['id'=>$member->id])}}" class="btn btn-info">Edit</a>
                                                <a href="{{route('project.delete',['id'=>$member->id])}}" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
